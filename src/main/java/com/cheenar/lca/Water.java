...
public class Water
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        for(String key : headers.keySet())
        {
            ...
            {
                cookies = (ArrayList<String>) headers.get(key);
            }
        }
        ...
        HttpResponse<String> postReq = Unirest.post("https://www.livecoding.tv/accounts/login/").header("referer", "https://www.livecoding.tv/accounts/login/").header("cookie", cookie.toString()).field("csrfmiddlewaretoken", token).field("login", args[0]).field("password", args[1]).asString();
